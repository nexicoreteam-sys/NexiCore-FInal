...
const services = [
  {
    ...
    description:
      "Website-uri rapide, moderne și optimizate SEO care generează credibilitate și încredere pentru afacerea ta.",
    accent: "#02defc",
  },
  {
    icon: (
    ...
    description:
      "Asistent AI inteligent care califică lead-uri, răspunde întrebărilor și automatizează comunicarea cu potențialii clienți.",
    accent: "#fc0197",
  },
  {
    icon: (
    ...
    description:
      "Strategii SEO locale pentru România. Aducem afacerea ta în fața clienților care te caută activ online.",
    accent: "#7ffe00",
  },
  {
    icon: (
    ...
    title: "Landing Pages",
    description:
      "Pagini de destinație optimizate pentru conversie care transformă vizitatorii în clienți potențiali.",
    accent: "#f47319",
  },
  {
    icon: (
    ...
    title: "Automatizări",
    description:
      "Fluxuri automate de email, notificări și integrări care economisesc timp și reduc erorile umane.",
    accent: "#fdf301",
  },
  {
    icon: (
    ...
    description:
      "Experiențe impecabile pe orice dispozitiv — desktop, tabletă sau mobil. Fiecare pixel contează.",
    accent: "#02defc",
  },
];
