    ...
    <footer className="relative bg-[#030303]">
      ...
      <div className="relative max-w-[1400px] mx-auto px-6 lg:px-10 pt-12 pb-8">
        <motion.div
          ...
          className="flex flex-col lg:flex-row gap-12 lg:items-start lg:justify-center lg:gap-24"
        >
          {/* ─── LEFT: Company Info ─── */}
          <motion.div custom={0} variants={fadeUp} className="lg:max-w-[400px]">
            {/* Logo */}
            ...
            <p className="text-[13px] leading-relaxed text-white/35 mb-6">
          ...
          {/* ─── RIGHT: Nav + Contact side by side ─── */}
          <motion.div custom={1} variants={fadeUp} className="flex flex-col sm:flex-row gap-12 sm:gap-20 lg:gap-24">
            {/* Navigare */}
            <div>
            ...
            <div>
              ...
              <ul className="space-y-4">
                <li>
                  <a href="mailto:nexicoreteam@gmail.com" className="group flex items-center gap-3 text-[13px] text-white/30 hover:text-[#02defc] transition-colors duration-300">
                    <span className="flex items-center justify-center w-9 h-9 rounded-xl border border-[#1a1a1a] bg-[#060606] group-hover:border-[#02defc]/30 group-hover:bg-[#02defc]/5 transition-all duration-300 shrink-0">
                      <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="opacity-50 group-hover:opacity-100 transition-opacity duration-300">
                        <path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z" />
                        <polyline points="22,6 12,13 2,6" />
                      </svg>
                    </span>
                    nexicoreteam@gmail.com
                  </a>
                </li>
                <li>
                  <a href="tel:+40745292353" className="group flex items-center gap-3 text-[13px] text-white/30 hover:text-[#02defc] transition-colors duration-300">
                    <span className="flex items-center justify-center w-9 h-9 rounded-xl border border-[#1a1a1a] bg-[#060606] group-hover:border-[#02defc]/30 group-hover:bg-[#02defc]/5 transition-all duration-300 shrink-0">
                      <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="opacity-50 group-hover:opacity-100 transition-opacity duration-300">
